...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      ...
      { title: 'BarcodeScanner', component: BarcodescanPage, icon: 'barcode' },
      { title: 'Flashlight', component: FlashPage, icon: 'flash' },
      { title: 'JsonMenu', component: JsonMenuPage, icon: 'book' },
      { title: 'MovieApp', component: Minproject_1Page, icon: 'logo-youtube' },
    ];
